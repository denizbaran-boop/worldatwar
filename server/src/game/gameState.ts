import { MAP_SIZE_PRESETS } from "./constants";
import { createInitialFog, discoverMany, discoverTileAndNeighborsOnMap } from "./fogOfWar";
import { generateHexGrid, pickStartingCapitalKeys } from "./map";
import {
  applyVillageMarkersToTiles,
  generateGoldMines,
  generateVillages
} from "./villageSystem";
import { claimCapitalStartingTerritory, createStartingUnits, placeCapitals, setupPlayers } from "./actions";
