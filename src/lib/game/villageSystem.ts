import { GOLD_MINE_COUNT, VILLAGE_COUNT } from "@/lib/game/constants";
import { axialDistance } from "@/lib/game/map";
import type { Tile, Village } from "@/lib/game/types";
import { makeId, shuffleWithSeed } from "@/lib/game/utils";
...
export const generateVillages = (tiles: Tile[], seed: number, count = VILLAGE_COUNT): Village[] => {
  ...
  // Fallback: fill any remaining slots from the full zone pool
