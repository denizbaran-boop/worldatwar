import type { TechNode, TechNodeId } from "@/lib/game/types";

// Layout:  Defense (←) ← [Basic Soldier] → (→) Ground
//                               ↑ Air
//
// gridX > 0  = Ground branch  (right)
// gridX < 0  = Defense branch (left)
// gridX == 0 = Air branch     (up, negative gridY)
...
export const TECH_TREE_NODES: TechNode[] = [
  ...
  // ── Ground branch (→ right, ordered by cost) ──────────────────────────────
  {
    id: "strong_soldier",
    name: "Strong Soldier",
    cost: 90,
  ...
  // ── Defense branch (← left, ordered by cost) ──────────────────────────────
  {
    id: "warrior",
    name: "Warrior",
    cost: 130,
  ...
  // ── Air branch (↑ up, ordered by cost — cheaper closer to center) ──────────
  {
    id: "aircraft",
    name: "Fighter Jet",
    cost: 300,
